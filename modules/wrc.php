...
if (isset($_GET["ajax"]) && $_GET["ajax"] == 1) {
    $sql = "SELECT championship_year, driver_name, driver_country, team_name, team_country FROM wrc_wdc ORDER BY championship_year ASC";
...
if (isset($_GET["ajax"]) && $_GET["ajax"] == 2) {
    $sql = "SELECT championship_year, team_name, team_country FROM wrc_wcc ORDER BY championship_year ASC";
    $result = mysqli_query($connection, $sql);
